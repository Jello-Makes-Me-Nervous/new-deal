...
function getModernStyles() {
    return '<style>
        * {
        ...
        .modern-nav, .hero, .features, .app-section, .modern-footer {
            width: 100% !important;
            max-width: none;
        ...
        .sponsors-slider.corporate-section {
            background: white;
            padding: 5rem 2rem;
        }
        ...
        .sponsors-slider.corporate-section .sponsors-title {
            font-size: 2.5rem;
            font-weight: 800;
            background: linear-gradient(135deg, #0066FF 0%, #003D99 100%);
            -webkit-background-clip: text;
        ...
        .sponsors-slider.corporate-section .sponsors-subtitle {
            color: #003D99;  /* Slightly lighter navy */
            font-size: 1.2rem;
        }
        ...
        .sponsors-slider.corporate-section .sponsor-card {
            background: #f8fafc;
        ...
        .sponsors-slider.corporate-section .sponsor-card:hover {
        ...
        .sponsors-slider.corporate-section .sponsor-name {
...
function getModernHomepage() {
    ...
    <nav class="modern-nav" id="navbar" style="position: fixed !important; top: 0 !important; left: 0 !important; right: 0 !important;">
        <div class="nav-container">
            <a href="/index.php" class="logo-link">
                <img src="/images/dealernetx-logo.png" alt="DealernetX" class="logo-img">
            </a>
            <div class="nav-links">
    ...
    <!-- Corporate Sponsors Section - Moved here with white background -->
    <section class="sponsors-slider corporate-section">
    ...
    foreach ($allCorporate as $corp) {
        ...
        $corpPlaceholder = base64_encode('<svg width="200" height="120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" fill="#f0f0f0"/><text text-anchor="middle" x="100" y="60" font-family="Arial" font-size="14" fill="#666">' . htmlspecialchars($corp['name']) . '</text></svg>');
