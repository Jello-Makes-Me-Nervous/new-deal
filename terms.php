...
ob_start();
echo $page->header('DealernetX - Terms of Service');
...
echo getModernStyles();
echo '</head><body>';

// Include modern header navigation from includes folder
require_once('includes/header.php');

echo getTermsContent();

// Include modern footer from includes folder
